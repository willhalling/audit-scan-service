...
async function testConversionOptimization() {
  ...
  try {
    ...
    console.log('Trust Signals:', samplePageData.trustSignals);
    console.log('Analytics Tracking:', samplePageData.analyticsTracking);
    console.log('Forms:', samplePageData.forms);
